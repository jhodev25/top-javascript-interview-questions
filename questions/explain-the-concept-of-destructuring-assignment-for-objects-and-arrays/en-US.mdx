...
You can collect the remaining elements into a new array using the rest syntax (`...`).
...
You can collect the remaining properties into a new object using the rest syntax (`...`).
