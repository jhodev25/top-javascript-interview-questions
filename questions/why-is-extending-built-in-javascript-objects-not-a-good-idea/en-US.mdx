...
Extending built-in JavaScript objects modifies the global scope and it's not a good idea because:
...
Read more about [why it is a bad idea to modify the global scope](/questions/quiz/why-is-it-in-general-a-good-idea-to-leave-the-global-scope-of-a-website-as-is-and-never-touch-it).
