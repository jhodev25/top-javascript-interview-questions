...
In the example above, using a traditional function for `increment` would lose the correct `this` context when called, requiring additional steps like `bind` to fix it.
